#ifndef GROUND_STATION_DATA_H
#define GROUND_STATION_DATA_H

/**
 * Ground Station Configuration Data
 *
 * Contains predefined city locations for creating ground station networks.
 * Separate from Constants.h to keep physical constants distinct from
...
// This array can be used to quickly populate a ground station network
